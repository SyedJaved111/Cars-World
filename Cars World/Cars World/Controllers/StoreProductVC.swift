...
class StoreProductVC: UIViewController,IndicatorInfoProvider{
...
extension StoreProductVC:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
