...
class ManufactorVC: BaseController{
    ...
    var manufacturerList = ["BMW","Volkswagen","Mercedes","Mitsubishi","Ferrari","Volvo"]
...
extension ManufactorVC:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
