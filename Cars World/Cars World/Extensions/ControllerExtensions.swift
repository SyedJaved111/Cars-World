...
extension UIViewController {
    ...
    func addBackButton(backImage: UIImage = #imageLiteral(resourceName: "Back-1")) {
        hideBackButton()
...
extension UIViewController {
    ...
    public func setNavigationBar(){
        let color: UIColor = #colorLiteral(red: 0.1183428243, green: 0.7272036672, blue: 0.3827357888, alpha: 1)
        self.navigationController!.navigationBar.isTranslucent = false
        self.navigationController!.navigationBar.tintColor = UIColor.white
        self.navigationController!.navigationBar.barTintColor = color
        self.navigationController?.navigationBar.titleTextAttributes = [ NSAttributedStringKey.font: UIFont(name: "Raleway-Medium", size: 20)! , NSAttributedStringKey.foregroundColor: UIColor.white]
